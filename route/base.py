...
from route import route_users, route_login, route_product, route_ingredient, route_diet, route_basket
...
api_router.include_router(route_basket.router, prefix="/basket", tags=["basket"])
